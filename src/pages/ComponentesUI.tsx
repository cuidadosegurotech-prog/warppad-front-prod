  ...
  return (
    <div className="space-y-8">
      ...
      <Tabs defaultValue="componentes" className="w-full">
        ...
        <TabsContent value="componentes" className="space-y-8 mt-6">
          {/* Botones */}
          <Card>
            <CardHeader>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Formularios Básicos</CardTitle>
              <CardDescription>Campos de entrada y controles de formulario básicos</CardDescription>
            </CardHeader>
