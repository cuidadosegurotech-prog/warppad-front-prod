...
const serviciosDisponibles = {
  ...
  "CLINICA DE HERIDAS": [
    ...
    "869500 - CURACION DE HERIDAS DE BAJA COMPLEJIDAD CON TECNOLOGIA",
    "869500 - CURACION DE HERIDAS DE ALTA COMPLEJIDAD CON TECNOLOGIA",
    "869500 - CURACION CONVENCIONAL DE HERIDAS",
